 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Shade Alabsa");
		  toPrint += p1.toString("salabsa3");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Michael Sambol");
		  toPrint += p2.toString("msambol3");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Kevin Zhou");
		  toPrint += p3.toString("qzhou38");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Nathanial Heard");
          toPrint += p4.toString("nheard3");
