...
public class NurseUI extends JFrame {
	...
	public NurseUI(String username, AVL<String, Info> information, AVL<String, Info> informationName) {
		admin = new SystemAdmin(username, information, informationName);
		initialize();		
		this.setVisible(true);
	}
	
	public NurseUI(SystemAdmin admin){
		this.admin = admin;
		initialize();
		this.setVisible(true);
	}
	...
	private void initialize() {
		...
		"", 1);
		        if(str != null){
		          //admin.getInfo().setPhone(Integer.parseInt(str));
		        }
			}
		    });
	...
	"", 1);
		...
		DoctorsOrdersPanel.setLayout(gbl_DoctorsOrdersPanel);
				...
				btnCreateInvoice.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						//admin.createInvoice(name,doc, due, total, paid);
					}
				});
		...
		btnCreate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				admin.createUser(textFieldNewName.getText(), textFieldPassword.getText(), 
						textFieldUsername.getText(), textFieldNewEmail.getText(), 
						textFieldNewAddress.getText(), textFieldNewState.getText(), 
