...
public class DefaultUI1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DefaultUI1 frame = new DefaultUI1();
	...
	private void initialize() {
		...
		JLabel lblSelectTreament = new JLabel("select treament record");
		GridBagConstraints gbc_lblSelectTreament = new GridBagConstraints();
		gbc_lblSelectTreament.insets = new Insets(0, 0, 5, 5);
		gbc_lblSelectTreament.gridx = 1;
		gbc_lblSelectTreament.gridy = 1;
		panel_3.add(lblSelectTreament, gbc_lblSelectTreament);
		...
		JLabel lblSelectTreatmentRecord_1 = new JLabel(
		...
		JLabel lblSelectTreatmentRecord_2 = new JLabel(
				"select treatment record");
		...
		JLabel lblSelectTreatmentRecord_3 = new JLabel(
				"select treatment record");
		...
		gbl_panel_8.columnWeights = new double[] { 0.0, 0.0, 1.0,
				Double.MIN_VALUE };
