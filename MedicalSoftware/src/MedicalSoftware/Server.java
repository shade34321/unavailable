	...
	public AVL<String, Info> load() {
		...
		try {
			...
			for (int i = 0; i < array.size(); i += 12) {
				...
				info = new Info(array.get(i), array.get(i + 1),
						array.get(i + 2), array.get(i + 3), array.get(i + 4),
						array.get(i + 5), array.get(i + 6),
						(int) Double.parseDouble(array.get(i + 7)),
						(int) Double.parseDouble(array.get(i + 8)),
						(int) Double.parseDouble(array.get(i + 9)),
						(int) Double.parseDouble(array.get(i + 10)), status);
